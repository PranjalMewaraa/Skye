...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reocverpass=findViewById(R.id.passrec);
        newdnewaccount=findViewById(R.id.newaa);
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (task.getResult().getAdditionalUserInfo().isNewUser()) {
                        ...
                        hashMap.put("image", "");
                        hashMap.put("cover", "");
                        FirebaseDatabase database = FirebaseDatabase.getInstance("https://console.firebase.google.com/u/0/project/skye-app-a870a/database/skye-app-a870a-default-rtdb/data/~2F");
