...
public class PostDetailActivity extends AppCompatActivity {
        ...
        liekeref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(postId).hasChild(myuid)) {
                    likebtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.liked, 0, 0, 0);
    ...
    private void postComment() {
        ...
        if (TextUtils.isEmpty(commentss)) {
            Toast.makeText(PostDetailActivity.this, "Empty comment", Toast.LENGTH_LONG).show();
            return;
        }
        progressDialog.show();
        ...
        datarf.child(timestamp).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(PostDetailActivity.this, "Added", Toast.LENGTH_LONG).show();
                comment.setText("");
                updatecommetcount();
            }
        ...
        myref.orderByChild("uid").equalTo(myuid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    try {
                        Glide.with(PostDetailActivity.this).load(mydp).into(imagep);
                    } catch (Exception e) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if(dataSnapshot1.child("uimage").getValue()==null){
                        uimage="";
                    }else{
                    ...
                    if (uimage.equals("")) {
                        ...
                        try {
                            Glide.with(PostDetailActivity.this).load(uimage).into(image);
                        } catch (Exception e) {

                        }
                    }
                    try {
                        Glide.with(PostDetailActivity.this).load(hisdp).into(picture);
                    } catch (Exception e) {
