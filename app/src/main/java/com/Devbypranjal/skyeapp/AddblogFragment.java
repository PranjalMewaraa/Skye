...
public class AddblogFragment extends Fragment {
    ...
    Uri imageuri = null;
    CardView cardView;
    String nameRS,name,imageDP, email, uid, dp, Pname;
    Button upload,uploadSrt;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    Log.e("NAME",""+name);
                    nameRS = "" + dataSnapshot1.child("name").getValue();
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (imageuri == null) {
                    ...
                    uploadDataWithoutIMG(description,nameRS);
                    return;
                } else {
                    uploadData(description,nameRS);
                    image.setVisibility(View.VISIBLE);
                }
            }
        });
        uploadSrt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getContext(),AddShortsActivity.class));
            }
        });
        return view;
    }
    ...
    private void uploadData(final String description, String nameX) {
        ...
        storageReference1.putBytes(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                if (uriTask.isSuccessful()) {
                    ...
                    hashMap.put("udp", dp);
                    hashMap.put("description", name+": "+description);
    ...
    private void uploadDataWithoutIMG(final String description, String nameX) {
        // show the progress dialog box
        pd.setMessage("Publishing Post");
        pd.show();
        final String timestamp = String.valueOf(System.currentTimeMillis());
